...
def av_cpu_ini():
    ...
    cpu_starting_chart:list = [[cpu_zero_fill*cpu_bar_width if box == 0 else cpu_fill*cpu_bar_width for box in range(cpu_bar_height)]for _ in range(cpu_chart_width)]
